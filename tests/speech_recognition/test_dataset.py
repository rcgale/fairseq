...
class TestDataset(unittest.TestCase):
    ...
    def test_get_features_or_waveform(self):
        test_cases = [
            (
                "/path/to/myfile1.wav", {"need_waveform": True, "use_sample_rate": -1},
                random_wav_data(size=456),
                (None, None, None),
                call("/path/to/myfile1.wav", frames=-1, start=0, always_2d=True, dtype="float32"),
            ),
            (
                "/path/to/myfile1.wav:123:456", {"need_waveform": True, "use_sample_rate": -1},
                random_wav_data(size=456, pad_wav=123),
                (None, None, None),
                call("/path/to/myfile1.wav", frames=456, start=123, always_2d=True, dtype="float32"),
            ),
            (
                "/path/to/myfile1.wav:123:456", {"need_waveform": False, "use_sample_rate": -1},
                random_wav_data(size=456, pad_wav=123),
                (None, None, None),
                call("/path/to/myfile1.wav", frames=456, start=123, always_2d=True, dtype="float32"),
            ),
            (
                "/path/to/myfile1.zip", {"need_waveform": True, "use_sample_rate": -1},
            ...
            (
                "/path/to/myfile2.zip:123:456", {"need_waveform": True, "use_sample_rate": -1},
